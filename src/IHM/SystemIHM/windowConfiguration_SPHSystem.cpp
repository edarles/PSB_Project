...
WindowConfiguration_SPHSystem::WindowConfiguration_SPHSystem(GLWidget *widget)
{
	...
	MinSX->setValue(-2.0);   MinSY->setValue(-2.0); MinSZ->setValue(-2.0); 
	...
	MaxSX->setValue(2.0);   MaxSY->setValue(2.0); MaxSZ->setValue(2.0); 
...
/****************************************************************************/	
void  WindowConfiguration_SPHSystem::changeMinS(double d)
{
	SPHSystem *system = (SPHSystem*) glWidget->getSystem();
	system->setMinS(Vector3(MinSX->value(),MinSY->value(),MinSZ->value()));
}
/****************************************************************************/	
void  WindowConfiguration_SPHSystem::changeMaxS(double d)
{
	SPHSystem *system = (SPHSystem*) glWidget->getSystem();
	system->setMaxS(Vector3(MaxSX->value(),MaxSY->value(),MaxSZ->value()));
}

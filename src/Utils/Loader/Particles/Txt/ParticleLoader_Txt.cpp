...
/**************************************************************************************/
/**************************************************************************************/
vector<Particle*> ParticleLoader_Txt::load(System* S, const char *filename)
{
	FILE *f = fopen(filename,"r");
 	if(f!=NULL){
		if(typeid(*S)==typeid(SimpleSystem))
			return loadSimpleSystem(f);
	}	
}
/**************************************************************************************/
/**************************************************************************************/
vector<Particle*> ParticleLoader_Txt::loadSimpleSystem(FILE* f)
{

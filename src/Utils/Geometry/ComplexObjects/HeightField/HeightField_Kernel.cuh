#ifndef __HEIGHT_FIELD_KERNEL_
#define __HEIGHT_FIELD_KERNEL_
...
/****************************************************************************************************************************/
	__global__ void HeightField_initializeHeight_Kernel(double yC, double3* m_pos, uint nbPos);
/****************************************************************************************************************************/
	__global__ void HeightField_initializeHeight_Normales_Kernel(double3* pos,
			double3* m_x0, double3* m_x1, double3* m_z0, double3* m_z1, double x,double y,double z, uint nbPos);
}
/****************************************************************************************************************************/
/****************************************************************************************************************************/
#endif

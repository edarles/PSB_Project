...
/***********************************************************************************************/
/***********************************************************************************************/
SimulationData_MSPHSystem::SimulationData_MSPHSystem():SimulationData_SPHSystem()
{
	...
	phase = new Phase(temperature,1.0,Vector3(1,1,1),sigma,beta,g);
	phase->calculateD0(viscosity, restDensity, particleRadius, gasStiffness); 
}
/***********************************************************************************************/
SimulationData_MSPHSystem::SimulationData_MSPHSystem(float particleRadius, float mass, Vector3 color,
						       ...
						       gasStiffness,kernelParticles)
{
	...
	this->beta = beta;
	this->g = g;
	this->phase = new Phase(temperature, 1.0, color, sigma, beta, g);
	this->phase->calculateD0(viscosity, restDensity, particleRadius, gasStiffness); 
	printf("mass:%f\n",this->particleMass);
}
/***********************************************************************************************/
...
/***********************************************************************************************/
/***********************************************************************************************/
Phase* SimulationData_MSPHSystem::getPhase()
{
	return phase;
}
/***********************************************************************************************/
...
/***********************************************************************************************/
void SimulationData_MSPHSystem::setPhase(Phase *p)
{
	this->phase = p;
}
/***********************************************************************************************/
...
/***********************************************************************************************/
/***********************************************************************************************/
bool SimulationData_MSPHSystem::loadConfiguration(const char* filename)
{
...
/***********************************************************************************************/
bool SimulationData_MSPHSystem::saveConfiguration(const char* filename)
{
	TiXmlDocument doc;
